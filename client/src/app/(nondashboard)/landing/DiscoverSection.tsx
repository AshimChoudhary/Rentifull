      ...
      <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <motion.div variants={itemVariants} className="my-12 text-center">
          ...
          <p className="mt-2 text-gray-500 max-w-3xl mx-auto">
            Searching your dream rental property has never been easier. With our
            user-friendly search feature, you can quickly find the perfect home
            that meets all your needs. Start your search today and discover your
...
const DiscoverCard = ({
  ...
  <div className="px-4 py-12 shadow-lg rounded-lg bg-rose-50 md:h-72">
    <div className="bg-gray-800 p-[0.6rem] rounded-full mb-4 h-10 w-10 mx-auto">
      <Image
        src={imageSrc}
        width={30}
        height={30}
